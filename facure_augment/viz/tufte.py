"""
Tufte-inspired styling for augmented visualizations.

Adapted from temporalcv for consistent research-grade plots.

Implements Edward Tufte's principles:
1. Maximize data-ink ratio
2. Eliminate chartjunk
3. Use direct labeling instead of legends
4. Integrate graphics and text

References
----------
- Tufte, E. R. (1983). The Visual Display of Quantitative Information.
- temporalcv: ~/Claude/temporalcv/src/temporalcv/viz/_style.py
"""
...
TUFTE_PALETTE: Dict[str, str] = {
    ...
    # Causal inference semantic aliases (for notebook convenience)
    "treatment": "#4c72b0",  # Same as info
    "control": "#8a8a8a",  # Same as secondary
    "effect": "#c44e52",  # Same as accent
    "bias": "#c44e52",  # Same as accent
    "confidence": "#4c72b0",  # Same as info
    "estimate": "#4a4a4a",  # Same as primary
    "true_value": "#55a868",  # Same as success
    "residual": "#dd8452",  # Same as warning
}

# Semantic aliases for causal inference visualizations
COLORS = {
    "treatment": TUFTE_PALETTE["info"],
    "control": TUFTE_PALETTE["secondary"],
    "effect": TUFTE_PALETTE["accent"],
    "confidence": TUFTE_PALETTE["info"],
    "estimate": TUFTE_PALETTE["primary"],
    "true_value": TUFTE_PALETTE["success"],
    "bias": TUFTE_PALETTE["accent"],
    "residual": TUFTE_PALETTE["warning"],
    # Basic color aliases for general plotting
    "red": TUFTE_PALETTE["accent"],      # Red/coral for warnings, bias
    "green": TUFTE_PALETTE["success"],   # Green for success, correct
    "blue": TUFTE_PALETTE["info"],       # Blue for treatment, info
    "orange": TUFTE_PALETTE["warning"],  # Orange for warnings, partial
    "gray": TUFTE_PALETTE["secondary"],  # Gray for neutral, control
    "purple": "#9467bd",                 # Purple for alternatives
}
...
def muted_color(color: str, saturation: float = 0.7) -> str:
    ...
    ----------
    color : str
        Color name from TUFTE_PALETTE or COLORS, or a hex color.
    saturation : float
...
def apply_tufte_style(ax: Axes) -> Axes:
    ...
    - Subtle spine colors
    - Remove grid (high data-ink ratio)
